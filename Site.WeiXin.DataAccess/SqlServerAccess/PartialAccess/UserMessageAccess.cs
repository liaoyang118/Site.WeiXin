...
{
    public partial class UserMessageAccess
    {
        ...
        /// <returns></returns>
        public IList<UserMessage> SelectPageExcuteSql(string cloumns,string order, string whereStr, int pageIndex, int pageSize, out int rowCount)
        {
