...
namespace DataAccess.Model
{
	...
	public partial class Site_CMSBlockAccess : AccessBase<Site_CMSBlock>
    {
        ...
        public Site_CMSBlock Object2Model(IDataReader reader)
        {
            ...
            try
            {
				...
				obj.b_img_size = reader["b_img_size"] == null ? default(string) : (string)reader["b_img_size"];
	...
	public partial class Site_CMSItemAccess : AccessBase<Site_CMSItem>
    {
        ...
        public Site_CMSItem Object2Model(IDataReader reader)
        {
            ...
            try
            {
				...
				obj.i_p_gid = reader["i_p_gid"] == null ? default(string) : (string)reader["i_p_gid"];
				...
				obj.i_intro = reader["i_intro"] == null ? default(string) : (string)reader["i_intro"];
				obj.i_c_img_src = reader["i_c_img_src"] == null ? default(string) : (string)reader["i_c_img_src"];
	...
	[Serializable]
	public partial class Site_ContentAccess : AccessBase<Site_Content>
    {

		Database db;

        #region 00 IDisposable 实现
        public Site_ContentAccess(string configName)
        {
            db = DatabaseFactory.CreateDatabase(configName);
        }

        public Site_ContentAccess()
        {
            db = DatabaseFactory.CreateDatabase("MySite");
        }
        ...
        #region 01 Proc_Site_Content_Insert
		 public override int Insert(Site_Content obj)
		 {
		...
		#region 02 Proc_Site_Content_Delete
		 public override int Delete(int id)
		 {
		...
		#region 03 Proc_Site_Content_Update
		 public override int Update(Site_Content obj)
		 {
		...
		#region 04 Proc_Site_Content_SelectObject
		 public override Site_Content SelectObject(int id)
		 {
		...
		#region 05 Proc_Site_Content_Select
		 public override IList<Site_Content> Select(string whereStr)
		 {
			DbCommand dbCmd = db.GetStoredProcCommand("Proc_Site_Content_SelectList");
			db.AddInParameter(dbCmd, "@whereStr", DbType.String,whereStr);
			
			IList<Site_Content> list= new List<Site_Content>();
			try
            {
               using(IDataReader reader = db.ExecuteReader(dbCmd))
               {
					...
					{
						//属性赋值
						Site_Content obj= Object2Model(reader);
						list.Add(obj);
					}
                }
				return list;
		...
		#region 06 Proc_Site_Content_SelectPage
		 public override IList<Site_Content> SelectPage(string cloumns, string order, string whereStr, int pageIndex, int pageSize, out int rowCount)
		 {
        ...
        public Site_Content Object2Model(IDataReader reader)
        {
            Site_Content obj = null;
            try
            {
                obj = new Site_Content();
				obj.c_id = reader["c_id"] == null ? default(int) : (int)reader["c_id"];
				obj.c_gid = reader["c_gid"] == null ? default(string) : (string)reader["c_gid"];
				obj.c_c_gid = reader["c_c_gid"] == null ? default(string) : (string)reader["c_c_gid"];
				obj.c_title = reader["c_title"] == null ? default(string) : (string)reader["c_title"];
				obj.c_sub_title = reader["c_sub_title"] == null ? default(string) : (string)reader["c_sub_title"];
				obj.c_keywords = reader["c_keywords"] == null ? default(string) : (string)reader["c_keywords"];
				obj.c_intro = reader["c_intro"] == null ? default(string) : (string)reader["c_intro"];
				obj.c_content = reader["c_content"] == null ? default(string) : (string)reader["c_content"];
				obj.c_img_src = reader["c_img_src"] == null ? default(string) : (string)reader["c_img_src"];
				obj.c_createUserId = reader["c_createUserId"] == null ? default(string) : (string)reader["c_createUserId"];
				obj.c_createUserName = reader["c_createUserName"] == null ? default(string) : (string)reader["c_createUserName"];
				obj.c_createUserNickName = reader["c_createUserNickName"] == null ? default(string) : (string)reader["c_createUserNickName"];
				obj.c_createTime = reader["c_createTime"] == null ? default(DateTime) : (DateTime)reader["c_createTime"];
				obj.c_status = reader["c_status"] == null ? default(int) : (int)reader["c_status"];
				obj.c_state = reader["c_state"] == null ? default(bool) : (bool)reader["c_state"];
